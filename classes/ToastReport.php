 ...
 cardEntryMode=? AND businessDate=? AND restaurantID=?");
	...
	function buildSBSLine($data){
		$return="
				...
				<td style=\"text-align:right;width:5%;\">".$data['inStoreOrders']['Count']." / $".$this->switchNegNumber($data['inStoreOrders']['Total'],0)."</td>
				<td style=\"border-right:1px solid #e3e6ea;text-align:left;width:5%;\">".$data['lyinStoreOrders']['Count']." / $".$this->switchNegNumber($data['lyinStoreOrders']['Total'],0)."</td>
				<td style=\"text-align:right;width:5%;\">".$data['onlineOrders']['Count']." / $".$this->switchNegNumber($data['onlineOrders']['Total'],0)."</td>
				<td style=\"border-right:1px solid #e3e6ea;text-align:left;width:5%;\">".$data['lyonlineOrders']['Count']." / $".$this->switchNegNumber($data['lyonlineOrders']['Total'],0)."</td>
				<td style=\"text-align:right;width:5%;\">".$data['appOrders']['Count']." / $".$this->switchNegNumber($data['appOrders']['Total'],0)."</td>
				<td style=\"border-right:1px solid #e3e6ea;text-align:left;width:5%;\">".$data['lyappOrders']['Count']." / $".$this->switchNegNumber($data['lyappOrders']['Total'],0)."</td>
				<td style=\"text-align:right;width:5%;\">".$data['ritualOrders']['Count']." / $".$this->switchNegNumber($data['ritualOrders']['Total'],0)."</td>
				<td style=\"border-right:1px solid #e3e6ea;text-align:left;width:5%;\">".$data['lyritualOrders']['Count']." / $".$this->switchNegNumber($data['lyritualOrders']['Total'],0)."</td>
				<td style=\"text-align:right;width:5%;\">".$data['levelUpOrders']['Count']." / $".$this->switchNegNumber($data['levelUpOrders']['Total'],0)."</td>
				<td style=\"border-right:1px solid #e3e6ea;text-align:right;width:5%;\">".$data['lylevelUpOrders']['Count']." / $".$this->switchNegNumber($data['lylevelUpOrders']['Total'],0)."</td>
				<td style=\"text-align:right;width:5%;\">".$data['monkeyCount']['Count']." / $".$this->switchNegNumber($data['monkeyTotal']['Total'],0)."</td>
				<td style=\"border-right:1px solid #e3e6ea;text-align:left;width:5%;\">".$data['lymonkeyCount']['Count']." / $".$this->switchNegNumber($data['lymonkeyTotal']['Total'],0)."</td>
				<td style=\"text-align:right;width:5%;\">".$data['thirdParty']['Count']." / $".$this->switchNegNumber($data['thirdParty']['Total'],0)."</td>
				<td style=\"border-right:1px solid #e3e6ea;text-align:left;width:5%;\">".$data['lythirdParty']['Count']." / $".$this->switchNegNumber($data['lythirdParty']['Total'],0)."</td>
				<td style=\"text-align:right;width:5%;\">".$data['totalChecks']." / $".$this->switchNegNumber($data['totalSales'],0)."</td>
				<td style=\"text-align:right;width:5%;\">".$data['lytotalChecks']." / $".$this->switchNegNumber($data['lytotalSales'],0)."</td>
				</tr>
				";
				return $return;
	}
